...
void test_tob_mux_available_output_indexes() {
...
void test_available_output_indexes_1() {
    auto tob = TOB{0, 0};
...
void test_available_output_indexes_2() {
    auto tob = TOB{0, 0};
...
void test_randomly_map_remain_indexes() {
    auto tobmux = TOBMux{8};
