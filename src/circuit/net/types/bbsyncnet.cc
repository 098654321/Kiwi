...
namespace kiwi::circuit {
    ...
    BumpToBumpSyncNet::BumpToBumpSyncNet(Vector<BumpToBumpNet>& bbsyns):
    _nets(bbsyns),
    Net(SingleNETtype::BBsyncnet)
    {}
    ...
    auto BumpToBumpSyncNet::checkNetInfo(ofstream& outputfile) -> void
    {
        outputfile << "Synchronized net:" << std::endl;
        for (auto& net: _nets)
        {
