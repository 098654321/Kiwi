...
namespace kiwi::hardware {
    ...
    public:
        ...
        auto all_bump_to_hori_reg() -> std::Vector<int>;
        auto all_hori_to_vert_reg() -> std::Vector<int>;
        auto all_vert_to_track_reg() -> std::Vector<int>;
        auto all_bump_dir_reg() -> std::Vector<int>;
        auto all_track_dir_reg() -> std::Vector<int>;
        //
    ...
    public:
        ...
        auto bump(std::usize bump_index) -> Bump*;
