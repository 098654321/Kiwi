...
namespace kiwi::hardware {
    ...
    // update by tang, 2024-09-27
    auto COBUnit::whole_sel_reg(COBDirection dir) -> std::Array<COBSelRegister, 8>& {
        switch(dir)
        {
            case COBDirection::Up:  return this->_up_sel;
            case COBDirection::Down: return this->_down_sel;
            case COBDirection::Left: return this->_left_sel;
            case COBDirection::Right: return this->_right_sel;
            default: std::cerr << "cob direction error, no direction named " << int(dir) << std::endl;  exit(1);
        }
    }

    auto COBUnit::whole_sw_reg(COBDirection from_dir, COBDirection to_dir) -> std::Array<COBSwRegister, 8>& {
        switch (from_dir) {
            case COBDirection::Left: switch (to_dir) {
                case COBDirection::Left:  assert(false);
                case COBDirection::Right: return this->_switch_lr;
                case COBDirection::Up:    return this->_switch_lu;
                case COBDirection::Down:  return this->_switch_ld;
            }
            case COBDirection::Right: switch (to_dir) {
                case COBDirection::Left:  return this->_switch_lr;
                case COBDirection::Right: assert(false);
                case COBDirection::Up:    return this->_switch_ru;
                case COBDirection::Down:  return this->_switch_rd;
            }
            case COBDirection::Up: switch (to_dir) {
                case COBDirection::Left:  return this->_switch_lu;
                case COBDirection::Right: return this->_switch_ru;
                case COBDirection::Up:    assert(false);
                case COBDirection::Down:  return this->_switch_ud;
            }
            case COBDirection::Down: switch (to_dir) {
                case COBDirection::Left:  return this->_switch_ld;
                case COBDirection::Right: return this->_switch_rd;
                case COBDirection::Up:    return this->_switch_ud;
                case COBDirection::Down:  assert(false);
            }
        }
    }
