...
namespace kiwi::hardware {
    ...
    public:
        ...
        auto set_sw_resgiter_value(COBDirection from_dir, std::usize from_cob_index, COBDirection to_dir, COBSwState value) -> void; 
        
        auto sel_register(COBDirection dir, std::usize cob_index) -> COBSelRegister&;
        auto get_sel_resgiter_value(COBDirection dir, std::usize cob_index) -> COBSwState;
        auto set_sel_resgiter_value(COBDirection dir, std::usize cob_index, COBSignalDirection value) -> void; 

        // updated by tang, 2024-09-27
        auto all_sel_reg_value(COBDirection dir) -> std::Array<COBSelRegister, 128>;
        auto all_sw_reg_value(COBDirection from_dir, COBDirection to_dir) -> std::Array<COBSwState, 128>;
        //
